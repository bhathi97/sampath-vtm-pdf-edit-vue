<template>
  <v-app>
    <v-navigation-drawer app>
      ...
      <v-list dense nav>
          ...
          <v-expansion-panels>
            <v-expansion-panel>
              ...
              <v-expansion-panel-content>
                ...
                <v-btn color="primary" class="mt-2" width="200" @click="addItem" elevation="2" >Add </v-btn>
        ...
        <div class="bottom" >
          ...
          <v-btn color="success" class="mt-2 ml-3"  width="200" @click="saveCordinate"> Save </v-btn>
          <v-btn color="red" class="mt-2 ml-3"  width="200" @click="removeItems"> Clear </v-btn>
        </div>
      </v-list>
    ...
    <v-main>
      ...
      <div  id="drop-zone" style="width:1000px; height: 100%;" class="drop-zone" >
        <!-- <div ref="draggableContainer">
          <img src="../assets/logo.png"  @dragstart="initInteract(item.id,'sign',item.text)"  @mouseenter="enable(item.id)"/>
        </div> -->
      ...
      <Customer :embedSrc="this.embedSrc"  :reuslts="this.results" />
    </v-main>
  </v-app>
</template>
